-- =====================================================================
-- MAISON VIE v9.6 — SYNC SUPABASE UUIDS FROM RANDOM TO MASTER CODES
-- Run this script in Supabase SQL editor to correct random UUIDs.
-- =====================================================================

BEGIN;

-- 1. DROP ALL 14 FOREIGN KEY CONSTRAINTS TEMPORARILY
ALTER TABLE recipes DROP CONSTRAINT IF EXISTS fk_recipes_ing_uuid;
ALTER TABLE supplier_ingredients DROP CONSTRAINT IF EXISTS fk_supplier_ingredients_ing_uuid;
ALTER TABLE po_lines DROP CONSTRAINT IF EXISTS fk_po_lines_ing_uuid;
ALTER TABLE grn_lines DROP CONSTRAINT IF EXISTS fk_grn_lines_ing_uuid;
ALTER TABLE lots DROP CONSTRAINT IF EXISTS fk_lots_ing_uuid;
ALTER TABLE inventory_transactions DROP CONSTRAINT IF EXISTS fk_inventory_transactions_ing_uuid;
ALTER TABLE waste_logs DROP CONSTRAINT IF EXISTS fk_waste_logs_ing_uuid;
ALTER TABLE non_sale_consumption DROP CONSTRAINT IF EXISTS fk_non_sale_consumption_ing_uuid;
ALTER TABLE bar_bottle_calibration DROP CONSTRAINT IF EXISTS fk_bar_bottle_calibration_ing_uuid;
ALTER TABLE bar_counts DROP CONSTRAINT IF EXISTS fk_bar_counts_ing_uuid;
ALTER TABLE ingredient_departments DROP CONSTRAINT IF EXISTS fk_ingredient_departments_ing_uuid;
ALTER TABLE department_approval_audit_logs DROP CONSTRAINT IF EXISTS fk_department_approval_audit_logs_ing_uuid;
ALTER TABLE stock_take_lines DROP CONSTRAINT IF EXISTS fk_stock_take_lines_ing_uuid;
ALTER TABLE takeaway_packaging_map DROP CONSTRAINT IF EXISTS fk_takeaway_packaging_map_ing_uuid;

-- 2. CREATE A TEMPORARY MAPPING TABLE
CREATE TEMP TABLE temp_uuid_mapping (
    code text PRIMARY KEY,
    target_uuid uuid NOT NULL
);

-- 3. INSERT THE MASTER MAPPINGS (469 ITEMS)
...
('V9006', 'e9a3b2cf-61d0-40db-a3f1-c0b351cd33fa'),
('NLP6002', 'f28fc77f-9c3a-44f1-b43e-ad7e32b358cb'),
('NLP60048', 'a9b08709-9716-4b69-9351-f0dcd5c42f3b')
ON CONFLICT (code) DO NOTHING;

-- 4. UPDATE THE 14 REFERENCING CHILD TABLES
UPDATE recipes c
SET ingredient_id = m.target_uuid
FROM ingredients i
JOIN temp_uuid_mapping m ON i.code = m.code
...
SET packaging_id = m.target_uuid
FROM ingredients i
JOIN temp_uuid_mapping m ON i.code = m.code
WHERE c.packaging_id = i.id;

-- 5. UPDATE THE MAIN TABLE (ingredients)
UPDATE ingredients i
SET id = m.target_uuid
FROM temp_uuid_mapping m
WHERE i.code = m.code;

-- 6. RECREATE ALL 14 FOREIGN KEY CONSTRAINTS POINTING TO THE CORRECT UUIDs
ALTER TABLE recipes ADD CONSTRAINT fk_recipes_ing_uuid FOREIGN KEY (ingredient_id) REFERENCES ingredients(id);
ALTER TABLE supplier_ingredients ADD CONSTRAINT fk_supplier_ingredients_ing_uuid FOREIGN KEY (ingredient_id) REFERENCES ingredients(id);
ALTER TABLE po_lines ADD CONSTRAINT fk_po_lines_ing_uuid FOREIGN KEY (ingredient_id) REFERENCES ingredients(id);
ALTER TABLE grn_lines ADD CONSTRAINT fk_grn_lines_ing_uuid FOREIGN KEY (ingredient_id) REFERENCES ingredients(id);
ALTER TABLE lots ADD CONSTRAINT fk_lots_ing_uuid FOREIGN KEY (ingredient_id) REFERENCES ingredients(id);
ALTER TABLE inventory_transactions ADD CONSTRAINT fk_inventory_transactions_ing_uuid FOREIGN KEY (ingredient_id) REFERENCES ingredients(id);
ALTER TABLE waste_logs ADD CONSTRAINT fk_waste_logs_ing_uuid FOREIGN KEY (ingredient_id) REFERENCES ingredients(id);
ALTER TABLE non_sale_consumption ADD CONSTRAINT fk_non_sale_consumption_ing_uuid FOREIGN KEY (ingredient_id) REFERENCES ingredients(id);
ALTER TABLE bar_bottle_calibration ADD CONSTRAINT fk_bar_bottle_calibration_ing_uuid FOREIGN KEY (ingredient_id) REFERENCES ingredients(id);
ALTER TABLE bar_counts ADD CONSTRAINT fk_bar_counts_ing_uuid FOREIGN KEY (ingredient_id) REFERENCES ingredients(id);
ALTER TABLE ingredient_departments ADD CONSTRAINT fk_ingredient_departments_ing_uuid FOREIGN KEY (ingredient_id) REFERENCES ingredients(id);
ALTER TABLE department_approval_audit_logs ADD CONSTRAINT fk_department_approval_audit_logs_ing_uuid FOREIGN KEY (ingredient_id) REFERENCES ingredients(id);
ALTER TABLE stock_take_lines ADD CONSTRAINT fk_stock_take_lines_ing_uuid FOREIGN KEY (ingredient_id) REFERENCES ingredients(id);
ALTER TABLE takeaway_packaging_map ADD CONSTRAINT fk_takeaway_packaging_map_ing_uuid FOREIGN KEY (packaging_id) REFERENCES ingredients(id);
